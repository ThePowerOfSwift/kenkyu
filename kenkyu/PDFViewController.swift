...
class PDFViewController: UIViewController , MFMailComposeViewControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        let url = Bundle.main.url(forResource: "s", withExtension: "pdf")
        ...
        drawView.bringSubviewToFront(self.view)
        drawView.delegate = (self as DrawingViewDelegate)
    ...
    @objc func editBtnClick(sender: UIButton) {
        ...
        self.pdfview.documentView!.bringSubviewToFront(drawView)
